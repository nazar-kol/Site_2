...
$result=mysqli_query($mysql, "SELECT * FROM `bikes`");
?>
            ...
            while($bike=mysqli_fetch_assoc($result))
            {
              ...
              <div class="col-4">
                <div class="bike__div__cart">
                  <img class="bike__img" src="<?php echo $bike['img']; ?>" alt="" />
                  <h6 class="text-center"><?php echo $bike['name']; ?></h6>
                  <div class="bike__frame__bottom">
                    <button class="btn bike__btn">
                      <a class="btn_bike_a" href="<?php echo $bike['link']; ?>">Перегляути</a>
                    </button>
                  </div>
                </div>
              </div>
