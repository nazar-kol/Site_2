...
<html lang="uk">
  ...
  <body>
    ...
    <section class="contacts__first">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h1>Контактна інформація</h1>
            <p>
              Інтернет-магазин «VeloTern.com.ua» Для консультацій по телефону -
              дивіться інформацію про час роботи сайту.
            </p>
            <p>Тернопіль: <span class="bold">0352 221 290</span></p>
            <p>Viber: <span class="bold">066 911 54 40</span></p>
            <p>Vodafone: <span class="bold">067 981 89 65</span></p>
            <p>Lifecel: <span class="bold">093 764 27 28</span></p>
            <p class="contacts__p__buy">
              Купувати велосипеди та Комплектуючі потрібно тільки у лідерів
              ринку!!!
            </p>
          </div>
        </div>
